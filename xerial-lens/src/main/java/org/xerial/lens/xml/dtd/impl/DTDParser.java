...
public class DTDParser extends Parser {
    ...
    // DTD.g:246:1: entityDecl : ( '<!ENTITY' Name String '>' -> ^( ENTITY NAME[$Name.text] VALUE[$String.text] ) | '<!ENTITY' '%' Name String '>' -> ^( ENTITY_REF NAME[$Name.text] VALUE[$String.text] ) );
    public final DTDParser.entityDecl_return entityDecl() throws RecognitionException {
        ...
        try {
            // DTD.g:247:3: ( '<!ENTITY' Name String '>' -> ^( ENTITY NAME[$Name.text] VALUE[$String.text] ) | '<!ENTITY' '%' Name String '>' -> ^( ENTITY_REF NAME[$Name.text] VALUE[$String.text] ) )
            int alt21=2;
            ...
            switch (alt21) {
                ...
                case 2 :
                    ...
                    root_0 = (Object)adaptor.nil();
                    // 248:36: -> ^( ENTITY_REF NAME[$Name.text] VALUE[$String.text] )
                    {
                        // DTD.g:248:39: ^( ENTITY_REF NAME[$Name.text] VALUE[$String.text] )
                        {
                        Object root_1 = (Object)adaptor.nil();
