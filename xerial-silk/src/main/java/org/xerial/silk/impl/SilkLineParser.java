...
public class SilkLineParser extends Parser {
        ...
        try {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_silkNode_in_silkLine911);
                    silkNode2=silkNode();
                ...
                case 2 :
                    ...
                    LineComment3=(Token)match(input,LineComment,FOLLOW_LineComment_in_silkLine917); 
                ...
                case 3 :
                    ...
                    {
                    WhiteSpace4=(Token)match(input,WhiteSpace,FOLLOW_WhiteSpace_in_silkLine922);  
        ...
        try {
            ...
            switch (alt4) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_function_i_in_nodeValue952);
                ...
                case 2 :
                    ...
                    switch (alt3) {
                        case 1 :
                            ...
                            {
                            PlainOneLine7=(Token)match(input,PlainOneLine,FOLLOW_PlainOneLine_in_nodeValue966);  
                        ...
                        case 2 :
                            ...
                            {
                            String8=(Token)match(input,String,FOLLOW_String_in_nodeValue970);  
                ...
                case 3 :
                    ...
                    JSON9=(Token)match(input,JSON,FOLLOW_JSON_in_nodeValue981); 
        ...
        try {
            ...
            switch (alt8) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_indent_in_silkNode995);
                    indent10=indent();

                    state._fsp--;

                    stream_indent.add(indent10.getTree());
                    pushFollow(FOLLOW_nodeItem_in_silkNode997);
                    nodeItem11=nodeItem();
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_indent_in_silkNode1012);
                    indent12=indent();
                    ...
                    switch (alt5) {
                        case 1 :
                            ...
                            {
                            LParen13=(Token)match(input,LParen,FOLLOW_LParen_in_silkNode1015);  
                            stream_LParen.add(LParen13);

                            pushFollow(FOLLOW_attributeList_in_silkNode1017);
                            attributeList14=attributeList();

                            state._fsp--;

                            stream_attributeList.add(attributeList14.getTree());
                            RParen15=(Token)match(input,RParen,FOLLOW_RParen_in_silkNode1019);  
                    ...
                    switch (alt6) {
                        case 1 :
                            // SilkLine.g:254:42: plural
                            {
                            pushFollow(FOLLOW_plural_in_silkNode1023);
                            plural16=plural();
                    ...
                    switch (alt7) {
                        case 1 :
                            ...
                            {
                            Colon17=(Token)match(input,Colon,FOLLOW_Colon_in_silkNode1027);  
                            stream_Colon.add(Colon17);

                            pushFollow(FOLLOW_nodeValue_in_silkNode1029);
                ...
                case 3 :
                    ...
                    pushFollow(FOLLOW_function_in_silkNode1054);
                    function19=function();
    ...
    public final SilkLineParser.nodeItem_return nodeItem() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_nodeName_in_nodeItem1093);
            nodeName21=nodeName();
            ...
            switch (alt10) {
                case 1 :
                    ...
                    {
                    LParen23=(Token)match(input,LParen,FOLLOW_LParen_in_nodeItem1100);  
                    stream_LParen.add(LParen23);

                    pushFollow(FOLLOW_attributeList_in_nodeItem1102);
                    attributeList24=attributeList();

                    state._fsp--;

                    stream_attributeList.add(attributeList24.getTree());
                    RParen25=(Token)match(input,RParen,FOLLOW_RParen_in_nodeItem1104);  
            ...
            switch (alt11) {
                case 1 :
                    // SilkLine.g:266:62: plural
                    {
                    pushFollow(FOLLOW_plural_in_nodeItem1108);
                    plural26=plural();
            ...
            switch (alt12) {
                case 1 :
                    ...
                    {
                    Colon27=(Token)match(input,Colon,FOLLOW_Colon_in_nodeItem1112);  
                    stream_Colon.add(Colon27);

                    pushFollow(FOLLOW_nodeValue_in_nodeItem1114);
    ...
    public final SilkLineParser.dataType_return dataType() throws RecognitionException {
        ...
        try {
            ...
            LBracket29=(Token)match(input,LBracket,FOLLOW_LBracket_in_dataType1147); 
            pushFollow(FOLLOW_dataTypeName_in_dataType1150);
            dataTypeName30=dataTypeName();

            state._fsp--;

            adaptor.addChild(root_0, dataTypeName30.getTree());
            RBracket31=(Token)match(input,RBracket,FOLLOW_RBracket_in_dataType1152); 
    ...
    public final SilkLineParser.dataTypeName_return dataTypeName() throws RecognitionException {
        ...
        try {
            ...
            {
            PlainOneLine32=(Token)match(input,PlainOneLine,FOLLOW_PlainOneLine_in_dataTypeName1165);  
    ...
    public final SilkLineParser.attributeList_return attributeList() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_attributeItem_in_attributeList1185);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    Comma34=(Token)match(input,Comma,FOLLOW_Comma_in_attributeList1188); 
            	    pushFollow(FOLLOW_attributeItem_in_attributeList1191);
    ...
    public final SilkLineParser.attributeItem_return attributeItem() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_nodeItem_in_attributeItem1204);
            nodeItem36=nodeItem();
        ...
        try {
            ...
            switch (alt14) {
                case 1 :
                    ...
                    {
                    Star37=(Token)match(input,Star,FOLLOW_Star_in_plural1224);  
                ...
                case 2 :
                    ...
                    {
                    Plus38=(Token)match(input,Plus,FOLLOW_Plus_in_plural1234);  
                ...
                case 3 :
                    ...
                    {
                    Question39=(Token)match(input,Question,FOLLOW_Question_in_plural1244);  
                ...
                case 4 :
                    ...
                    {
                    Seq40=(Token)match(input,Seq,FOLLOW_Seq_in_plural1254);  
                ...
                case 5 :
                    ...
                    {
                    TabSeq41=(Token)match(input,TabSeq,FOLLOW_TabSeq_in_plural1264);  
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    {
                    NodeIndent42=(Token)match(input,NodeIndent,FOLLOW_NodeIndent_in_function1283);  
                    stream_NodeIndent.add(NodeIndent42);

                    pushFollow(FOLLOW_function_i_in_function1285);
                ...
                case 2 :
                    ...
                    {
                    FunctionIndent44=(Token)match(input,FunctionIndent,FOLLOW_FunctionIndent_in_function1301);  
                    stream_FunctionIndent.add(FunctionIndent44);

                    PlainOneLine45=(Token)match(input,PlainOneLine,FOLLOW_PlainOneLine_in_function1303);  
                    stream_PlainOneLine.add(PlainOneLine45);

                    LParen46=(Token)match(input,LParen,FOLLOW_LParen_in_function1305);  
                        ...
                        case 1 :
                            ...
                            do {
                            	...
                            	case 1 :
                            	    ...
                            	    {
                            	    Comma48=(Token)match(input,Comma,FOLLOW_Comma_in_function1311);  
                            	    stream_Comma.add(Comma48);

                            	    pushFollow(FOLLOW_functionArg_in_function1313);
                    ...
                    RParen50=(Token)match(input,RParen,FOLLOW_RParen_in_function1319);  
    ...
    public final SilkLineParser.function_i_return function_i() throws RecognitionException {
        ...
        try {
            ...
            {
            At51=(Token)match(input,At,FOLLOW_At_in_function_i1346);  
            stream_At.add(At51);

            PlainOneLine52=(Token)match(input,PlainOneLine,FOLLOW_PlainOneLine_in_function_i1348);  
            stream_PlainOneLine.add(PlainOneLine52);

            LParen53=(Token)match(input,LParen,FOLLOW_LParen_in_function_i1350);  
                ...
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    Comma55=(Token)match(input,Comma,FOLLOW_Comma_in_function_i1356);  
                    	    stream_Comma.add(Comma55);

                    	    pushFollow(FOLLOW_functionArg_in_function_i1358);
            ...
            RParen57=(Token)match(input,RParen,FOLLOW_RParen_in_function_i1364);  
        ...
        try {
            ...
            switch (alt20) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_nodeValue_in_functionArg1386);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_nodeName_in_functionArg1396);
                    nodeName59=nodeName();

                    state._fsp--;

                    stream_nodeName.add(nodeName59.getTree());
                    Colon60=(Token)match(input,Colon,FOLLOW_Colon_in_functionArg1398);  
                    stream_Colon.add(Colon60);

                    pushFollow(FOLLOW_nodeValue_in_functionArg1400);
    ...
    public static final BitSet FOLLOW_silkLine_in_silkFile890 = new BitSet(new long[]{0x00000000003E8002L});
    public static final BitSet FOLLOW_silkNode_in_silkLine911 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LineComment_in_silkLine917 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WhiteSpace_in_silkLine922 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_nodeName0 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_function_i_in_nodeValue952 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PlainOneLine_in_nodeValue966 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_String_in_nodeValue970 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_JSON_in_nodeValue981 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_indent_in_silkNode995 = new BitSet(new long[]{0x0020040000000000L});
    public static final BitSet FOLLOW_nodeItem_in_silkNode997 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_indent_in_silkNode1012 = new BitSet(new long[]{0x00000004BC800002L});
    public static final BitSet FOLLOW_LParen_in_silkNode1015 = new BitSet(new long[]{0x0020040000000000L});
    public static final BitSet FOLLOW_attributeList_in_silkNode1017 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_RParen_in_silkNode1019 = new BitSet(new long[]{0x00000004BC000002L});
    public static final BitSet FOLLOW_plural_in_silkNode1023 = new BitSet(new long[]{0x0000000004000002L});
    public static final BitSet FOLLOW_Colon_in_silkNode1027 = new BitSet(new long[]{0x0030040040000000L});
    public static final BitSet FOLLOW_nodeValue_in_silkNode1029 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_function_in_silkNode1054 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_set_in_indent0 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_nodeName_in_nodeItem1093 = new BitSet(new long[]{0x00000005BC800002L});
    public static final BitSet FOLLOW_dataType_in_nodeItem1095 = new BitSet(new long[]{0x00000004BC800002L});
    public static final BitSet FOLLOW_LParen_in_nodeItem1100 = new BitSet(new long[]{0x0020040000000000L});
    public static final BitSet FOLLOW_attributeList_in_nodeItem1102 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_RParen_in_nodeItem1104 = new BitSet(new long[]{0x00000004BC000002L});
    public static final BitSet FOLLOW_plural_in_nodeItem1108 = new BitSet(new long[]{0x0000000004000002L});
    public static final BitSet FOLLOW_Colon_in_nodeItem1112 = new BitSet(new long[]{0x0030040040000000L});
    public static final BitSet FOLLOW_nodeValue_in_nodeItem1114 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LBracket_in_dataType1147 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_dataTypeName_in_dataType1150 = new BitSet(new long[]{0x0000000200000000L});
    public static final BitSet FOLLOW_RBracket_in_dataType1152 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_PlainOneLine_in_dataTypeName1165 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_attributeItem_in_attributeList1185 = new BitSet(new long[]{0x0000000002000002L});
    public static final BitSet FOLLOW_Comma_in_attributeList1188 = new BitSet(new long[]{0x0020040000000000L});
    public static final BitSet FOLLOW_attributeItem_in_attributeList1191 = new BitSet(new long[]{0x0000000002000002L});
    public static final BitSet FOLLOW_nodeItem_in_attributeItem1204 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_Star_in_plural1224 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_Plus_in_plural1234 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_Question_in_plural1244 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_Seq_in_plural1254 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TabSeq_in_plural1264 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NodeIndent_in_function1283 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_function_i_in_function1285 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FunctionIndent_in_function1301 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_PlainOneLine_in_function1303 = new BitSet(new long[]{0x0000000000800000L});
    public static final BitSet FOLLOW_LParen_in_function1305 = new BitSet(new long[]{0x0030040041000000L});
    public static final BitSet FOLLOW_functionArg_in_function1308 = new BitSet(new long[]{0x0000000003000000L});
    public static final BitSet FOLLOW_Comma_in_function1311 = new BitSet(new long[]{0x0030040040000000L});
    public static final BitSet FOLLOW_functionArg_in_function1313 = new BitSet(new long[]{0x0000000003000000L});
    public static final BitSet FOLLOW_RParen_in_function1319 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_At_in_function_i1346 = new BitSet(new long[]{0x0020000000000000L});
    public static final BitSet FOLLOW_PlainOneLine_in_function_i1348 = new BitSet(new long[]{0x0000000000800000L});
    public static final BitSet FOLLOW_LParen_in_function_i1350 = new BitSet(new long[]{0x0030040041000000L});
    public static final BitSet FOLLOW_functionArg_in_function_i1353 = new BitSet(new long[]{0x0000000003000000L});
    public static final BitSet FOLLOW_Comma_in_function_i1356 = new BitSet(new long[]{0x0030040040000000L});
    public static final BitSet FOLLOW_functionArg_in_function_i1358 = new BitSet(new long[]{0x0000000003000000L});
    public static final BitSet FOLLOW_RParen_in_function_i1364 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_nodeValue_in_functionArg1386 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_nodeName_in_functionArg1396 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_Colon_in_functionArg1398 = new BitSet(new long[]{0x0030040040000000L});
    public static final BitSet FOLLOW_nodeValue_in_functionArg1400 = new BitSet(new long[]{0x0000000000000002L});
