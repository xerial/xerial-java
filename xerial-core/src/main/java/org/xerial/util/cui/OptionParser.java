 ...
 * </pre>
 * 
 * @param OptionID A {@link Integer} or {@link Enum} class that can be used IDs for options. OptionID must implement {@link Comparable} interface.
 * 
 * @author leo
 * 
 */
public class OptionParser<OptionID extends Comparable> {
	 ...
	 * @param shortOptionName the short option name, e.g. "h", which corresponds to "-h" in the command line arguments.
	 * @param longOptionName the long option name, e.g. "help", which corresponds to "--help" in the command line arguments.
	...
	/**
	 * @param option
	 * @deprecated use {@link #addOption(Comparable, String, String, String, OptionHandler)} instead.
	 */
     ...
     * @param longOptionName the long option name, e.g. "help", which corresponds to "--help" in the command line arguments.
     * @param description the description of the option, which is used to generate the help message of this option
     * @param presetValue when true, the option is assumed to be set in default, otherwise false
	 */
     ...
     * @param description the description of the option, which is used to generate the help message of this option
	 */
	public void addOptionWithArgument(OptionID optionID, String shortOptionName, String longOptionName, String argumentName, String description) {
		addNewOptionID(optionID);
	...
	/**
	 * Parses the command line arguments. After calling this method, you can retrieve 
	 * the status of options via {@link #isSet(Comparable)} or {@link #getValue(Comparable)} methods, etc.
	 * 
	 * @param args the command line arguments, which is given by the main(String[] args) method
	 * @throws OptionParserException when the given command line has invalid syntax or when incompatible options are set at the same time.
	 */
	 ...
	 * 
	 * @param optionID the target option that takes argument value
	 * @return the string value of the specified option argument 
	 * @throws OptionParserException if the specified option ID is not found or if the option cannot take arguments
	 */
     ...
     * 
     * @param optionID the target option that takes argument value
     * @param defaultValue the default value to be returned when this option is not present in the command line arguments
     * @return the string value of the specified option argument 
     * @throws OptionParserException if the specified option ID is not found or if the option cannot take arguments
	 */
	 ...
	 * 
	 * @return the help message that can be used as a list of command line options
	 */
