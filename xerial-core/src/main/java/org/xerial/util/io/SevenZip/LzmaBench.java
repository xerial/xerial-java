...
public class LzmaBench {
    ...
    static long GetTotalRating(int dictionarySize, long elapsedTimeEn, long sizeEn,
            long elapsedTimeDe, long inSizeDe, long outSizeDe) {
    ...
    static public int LzmaBenchmark(int numIterations, int dictionarySize) throws Exception {
        ...
        org.xerial.util.io.SevenZip.Compression.LZMA.Encoder encoder = new org.xerial.util.io.SevenZip.Compression.LZMA.Encoder();
        org.xerial.util.io.SevenZip.Compression.LZMA.Decoder decoder = new org.xerial.util.io.SevenZip.Compression.LZMA.Decoder();
