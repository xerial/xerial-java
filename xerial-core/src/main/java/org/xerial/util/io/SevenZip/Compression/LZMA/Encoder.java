package org.xerial.util.io.SevenZip.Compression.LZMA;

import java.io.IOException;

import org.xerial.util.io.SevenZip.ICodeProgress;
import org.xerial.util.io.SevenZip.Compression.RangeCoder.BitTreeEncoder;
...
public class Encoder {
    ...
    class LiteralEncoder {
        class Encoder2 {
            ...
            public void Init() {
                org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder
                        .InitBitModels(m_Encoders);
            }

            public void Encode(
                    org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder rangeEncoder,
            ...
            public int GetPrice(boolean matchMode, byte matchByte, byte symbol) {
                ...
                if (matchMode) {
                    for (; i >= 0; i--) {
                        int matchBit = (matchByte >> i) & 1;
                        int bit = (symbol >> i) & 1;
                        price += org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder
                ...
                for (; i >= 0; i--) {
                    int bit = (symbol >> i) & 1;
                    price += org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.GetPrice(
    ...
    class LenEncoder {
        ...
        public void Init(int numPosStates) {
            org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_choice);
        ...
        public void Encode(org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder rangeEncoder,
        ...
        public void SetPrices(int posState, int numSymbols, int[] prices, int st) {
            int a0 = org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder
                    .GetPrice0(_choice[0]);
            int a1 = org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder
                    .GetPrice1(_choice[0]);
            int b0 = a1
                    + org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder
                            .GetPrice0(_choice[1]);
    ...
    org.xerial.util.io.SevenZip.Compression.LZ.BinTree _matchFinder = null;
    org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder _rangeEncoder = new org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder();
    ...
    void Create() {
        if (_matchFinder == null) {
            org.xerial.util.io.SevenZip.Compression.LZ.BinTree bt = new org.xerial.util.io.SevenZip.Compression.LZ.BinTree();
            int numHashBytes = 4;
    ...
    void Init() {
        ...
        org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isMatch);
        org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRep0Long);
        org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRep);
        org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRepG0);
        org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRepG1);
        org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_isRepG2);
        org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.InitBitModels(_posEncoders);
    ...
    int GetRepLen1Price(int state, int posState) {
        return org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder
    ...
    int GetOptimum(int position) throws IOException {
        ...
        _optimum[1].Price = org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder
        ...
        int matchPrice = org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder
            ...
            if (len == 1 && pos == -1) {
                ...
                if (pos < Base.kNumRepDistances) {
                    ...
                    if (len == 1)
                        ...
                        _repMatchLenEncoder
                                .Encode(_rangeEncoder, len - Base.kMatchMinLen, posState);
    ...
    void SetStreams(java.io.InputStream inStream, java.io.OutputStream outStream, long inSize,
            long outSize) {
        _inStream = inStream;
        _finished = false;
        Create();
    ...
    public void Code(java.io.InputStream inStream, java.io.OutputStream outStream, long inSize,
            long outSize, ICodeProgress progress) throws IOException {
        _needReleaseMFStream = false;
        try {
    ...
    void FillDistancesPrices() {
        ...
        for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++) {
            ...
            for (posSlot = Base.kEndPosModelIndex; posSlot < _distTableSize; posSlot++)
                _posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1) - Base.kNumAlignBits) << org.xerial.util.io.SevenZip.Compression.RangeCoder.Encoder.kNumBitPriceShiftBits);
