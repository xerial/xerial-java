// $ANTLR 3.1.3 Mar 17, 2009 19:23:44 SilkLine.g 2010-07-12 09:58:19
...
public class SilkLineParser extends Parser {
        ...
        try {
            ...
            switch (alt8) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: indent, nodeValue, plural, attributeList
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final SilkLineParser.nodeItem_return nodeItem() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: nodeValue, dataType, plural, attributeList
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
