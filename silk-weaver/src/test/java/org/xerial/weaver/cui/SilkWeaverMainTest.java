...
public class SilkWeaverMainTest {
    ...
    @Test
    public void moduleHelp() throws Exception {
        SilkWeaverMain.main(new String[] { "bisulfite", "--help" });
    }

    @Test
    public void moduleCommandHelp() throws Exception {
        SilkWeaverMain.main(new String[] { "bisulfite", "convert", "--help" });
    }
}
